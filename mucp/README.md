...
MUCP is a transport agnostic communication protocol for Micro services. 
...
in closed networks users should have the choice to use whatever is a preference for their architectures. This directory serves as the default implementation.
